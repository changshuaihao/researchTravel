	...
	<view>
		...
		<view v-if="index==1" >
			<view class="middle" v-for="(item,index) in records" :key="index">
				<view class="middle01">
					<div>
						<image class="img" :src="yonghuwx.url"></image>
					</div>
					<view class="middle01-view">
						<view class="view-01">{{yonghuwx.username}}</view>
						<view class="view-02">{{time}}</view>
					</view>
					<view class="middle01-button" @click="guanzhu(item.id,time,item.input,item.travel_img,item.follow)">
						{{item.follow}}
					</view>
				</view>
				<view class="middle02">
		...
		<view v-if="index==0">
			<view class="middle" v-for="(item,index) in guanz" :key="index">
				<view class="middle01">
					...
					<view class="middle01-view">
						<view class="view-01">{{yonghuwx.username}}</view>
						<view class="view-02">{{item.time}}</view>
					</view>
					<view class="middle01-v" @click="quxiao(item.id)">
						取消
					</view>
				</view>
				<view class="middle02">
